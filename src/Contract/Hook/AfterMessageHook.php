...
/**
 * Implement AfterMessageHook Interface to to do stuff after the listener method is complete.
 * The method AfterMessageHook::after() is called even an Exception was thrown in a prior step.
 *
 */
